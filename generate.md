...
capture_params = [
  ...
  { :name =  { :name => "description", :message => "The `Radical Root Colonization Counter`, a lightweight web application, was designed to streamline grid intersect root scoring." },
  { :name => "license", :message => "MIT" },
"doi", :message => "Enter the DOI of the archived version of this code. (hit enter to skip)\nFor example http://dx.doi.org/10.6084/m9.figshare.828487" },
